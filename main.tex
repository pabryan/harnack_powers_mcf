...
The quantity
\eq{\~\chi=t(\del_t\p-\t)+\d\p}
satisfies the evolution equation
\eq{\label{WeakHarnackEv1}\del_t\~\chi-\Box\~\chi&=\br{\fr{\b-\t}{\d\p}+\p^{ij}(h^2)_{ij}+K\Phi}\~\chi-\fr{tK}{\d}\Phi(\b-\t)+K\Phi\p\\
...
We may also rewrite
$-\fr{tK}{\d}\Phi(\b-\t)+K\Phi\p=\fr{K\Phi}{\d}(-\tilde{\chi}+tK\p\Phi+2\d\p).$
This in turn implies that  $\~\chi$ satisfies the evolution equation
\eq{\label{WeakHarnackEv12}\del_t\~\chi-\Box\~\chi&=\br{\fr{\b-\t}{\d\p}+\p^{ij}(h^2)_{ij}+\left(1-\fr{1}{\d}\right)K\Phi}\~\chi+\fr{K\Phi\p}{\d}(tK\Phi+2\d)\\
				&+t\p^{ij,kl}\br{\eta_{ij}+K\p g_{ij}}\br{\eta_{kl}+K\p g_{kl}}+t\br{2b^{il}\p^{jk}-\fr{\p^{ij}\p^{kl}}{\d\p}}\eta_{ij}\eta_{kl}\\
...
\pf{
We simply use the evolution of $\chi,$ cf.~\eqref{thm:Evchi1}, and add the evolution of $tK\Phi\p.$ This is
