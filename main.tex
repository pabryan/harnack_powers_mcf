...
&\quad - 2b^{il} \varphi^{jk} \left(\gamma_{ij} \gamma_{kl} - 2\gamma_{kl} \nabla^2_{ij} \varphi + 2 \gamma_{ij}\varphi(h^2)_{kl} + \nabla^2_{ij}\varphi\nabla^2_{kl}\varphi\right) \\
&\quad + KR_{\theta}.
\end{split}
\]
\end{lemma}
...
&= 2 b^{ij} \nabla_j\varphi \varphi^{kl}(h^2)_{kl}\nabla_i \varphi + 2 b^{ij} \nabla_j\varphi K \varphi^{kl}g_{ki} \nabla_l \varphi \\
...
&\quad + 2 b^{ij} \nabla_j\varphi K \varphi \nabla_i \Phi \\
&= 2 \varphi^{kl}(h^2)_{kl}\theta + 2 b^{ij} \nabla_j\varphi K \varphi^{kl}g_{ki} \nabla_l \varphi \\
