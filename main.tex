...
\[
\begin{split}
(\partial_{t}-\Box)\theta &= \varphi^{rs}(h^2)_{rs}\theta - (2b^{lq}\varphi^{kp} + \varphi^{kl,pq})b^{ir}b^{js}\nabla_i \varphi\nabla_j\varphi \nabla_r h_{kl} \nabla_s h_{pq} \\
&\quad + (\varphi'f + \varphi - 2\varphi^{kl}h_{kl})|\nabla\varphi|^{2} + 2\varphi^{jl}h^{m}_{l}\nabla_m\varphi\nabla_j\varphi \\
&\quad + 2b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j\varphi (\nabla^2_{k,l} \varphi + (h^2)_{kl}\varphi) + 4b^{ij}\varphi^{kl}\nabla_i h_{rk}h^{r}_{l}\nabla_j \varphi\varphi \\
&\quad + 4\varphi^{rs}b^{ip}b^{jq}\nabla_r h_{pq}\nabla^2_{i,s} \varphi \nabla_j\varphi - 2b^{ij}\varphi^{rs}\nabla^2_{ir}\varphi\nabla^2_{js}\varphi \\
&\quad - K(\varphi'f + \varphi)b^{ir}b^{j}_{r}\nabla_i \varphi\nabla_j\varphi + K\varphi^{kl}g_{kl}\theta + 2K b^{j}_{k}\varphi^{kl}\nabla_l\varphi\nabla_j\varphi \\
&\quad + 2K b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j\varphi g_{kl}\varphi.
\end{split}
\]
\end{lemma}
...
\[
\begin{split}
(\partial_{t} - \Box)\theta &= (\partial_t b^{ij} - \Box b^{ij})\nabla_i\varphi\nabla_j\varphi + 2b^{ij}(\partial_t \nabla_i \varphi - \Box\nabla_i \varphi)\nabla_j\varphi \\
&\quad - 4\varphi^{rs}\nabla_r b^{ij}\nabla^2_{i,s}\varphi\nabla_j\varphi - 2b^{ij}\varphi^{rs}\nabla^2_{i,r}\varphi\nabla^2_{j,s}\varphi \\
&= -\varphi^{rs}h_{rk}h^{k}_{s}\theta + \br{\varphi'f+\varphi}|\nabla\varphi|^{2} - K\br{\varphi'f+\varphi}b^{ir}b^{j}_{r}\nabla_i \varphi\nabla_j\varphi \\
&\quad + K\varphi^{kl}g_{kl}\theta - \br{2b^{lq}\varphi^{kp} + \varphi^{kl,pq}} b^{ir}b^{js}\nabla_i\varphi\nabla_j\varphi\nabla_rh_{kl}\nabla_s h_{pq} \\
&\quad + 2\varphi^{kl}h_{rk}h^{r}_{l}\theta + 2b^{ij}\nabla_i\br{\varphi^{kl}h_{rk}h^{r}_{l}}\nabla_j\varphi\varphi + 2b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j\varphi\nabla^2_{k,l}\varphi \\
&\quad + 2b^{ij}\br{\varphi^{kl}h^{m}_{l}h_{ki} - \varphi^{kl}h_{kl}h^{m}_{i}}\nabla_m \varphi\nabla_j \varphi \\
&\quad + 2K b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j\varphi g_{kl}\varphi + 2K b^{j}_{k}\varphi^{kl}\nabla_l \varphi\nabla_j \varphi \\
&\quad - 4\varphi^{rs}\nabla_r {b^{ij}}\nabla^2_{i,s} \varphi\nabla_j\varphi - 2b^{ij}\varphi^{rs}\nabla^2_{i,r}\varphi\nabla^2_{j,s}\varphi \\
&= \varphi^{rs}h_{rk}h^{k}_{s}\theta - \br{2b^{lq}\varphi^{kp} + \varphi^{kl,pq}}b^{ir}b^{js}\nabla_i\varphi\nabla_j\varphi\nabla_rh_{kl}\nabla_sh_{pq} \\
&\quad + \br{\varphi'f + \varphi}|\nabla\varphi|^{2} + 2\varphi^{jl}h^{m}_{l}\nabla_m\varphi\nabla_j\varphi - 2\varphi^{kl}h_{kl}|\nabla\varphi|^{2} \\
&\quad + 2b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j \varphi\br{\nabla^2_{k,l} \varphi + h_{rk}h^{r}_{l}\varphi} + 4b^{ij}\varphi^{kl}\nabla_i h_{rk}h^{r}_{l}\nabla_j \varphi\varphi \\
&\quad - 4\varphi^{rs}\nabla_r{b^{ij}}\nabla^2_{i,s}\varphi\nabla_j\varphi - 2b^{ij}\varphi^{rs}\nabla^2_{i,r}\varphi\nabla^2_{j,s}\varphi \\
&\quad - K\br{\varphi'f + \varphi}b^{ir}b^{j}_{r}\nabla_i\varphi\nabla_j\varphi + K\varphi^{kl}g_{kl}\theta + 2K b^{j}_{k}\varphi^{kl}\nabla_l\varphi\nabla_j\varphi \\
&\quad + 2K b^{ij}\varphi^{kl,rs}\nabla_i h_{rs}\nabla_j\varphi g_{kl}\varphi.
\end{split}
\]
\end{proof}
