...
\begin{proof}
First, let us calculate the evolution of \(\varphi^{ij}\), which will also prove useful later. From equation \eqref{eq:delhdelg} and the evolution of the metric (Lemma \ref{lem:evolution}, (1)), we compute
\begin{equation}
\label{eq:deltBox}
\begin{split}
...
We obtain from equation \eqref{eq:deltBox} and the evolution of the Christoffel symbols (Lemma \ref{lem:evolution} (3)),
\[
\begin{split}
