...
For a convex $H^k$-flow satisfying a Harnack inequality we obtain $C^2$-estimates easily. For a curvature function $\p$ let us call a hypersurface $M$ $\p$-convex, if at every point $x\in M$ we have
